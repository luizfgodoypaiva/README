...
Build and maintain dashboards and KPIs focused on service level, quality, and performance

Use SQL to extract, clean, and validate data from multiple sources

Apply Python for automation, data manipulation, and advanced analysis
...
BI Tools (Power BI / Tableau / Looker – dashboards & reporting)

Python (Pandas, NumPy, automation, data quality checks)

Excel (advanced formulas, Power Query, data modeling)

ETL & Data Quality concepts
...
Order Fulfillment & Service Level Analysis
...
Improve service level and customer experience

Build reliable, clear, and actionable analytics solutions
